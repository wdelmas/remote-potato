...
export const RGBaster = () => {
    // Helper functions.
    var getContext = function (width: any, height: any) {
    ...
    var getImageData = function (img: any, loaded: any) {
    ...
    var makeRGB = function (name: any) {
        return ['rgb(', name, ')'].join('');
    };

    var mapPalette = function (palette: any) {
        var arr = [];
    ...
    var fitPalette = function (arr: any, fitSize: any) {
    ...
    var frmtPobj = function (a: any, b: any) {
    ...
    RGBaster.colors = function (img: any, opts: any) {
        ...
        getImageData(img, function (data: any) {
            ...
            if (opts.success) {
                ...
                opts.success({
                    ...
                    palette: palette.map(function (c: any) { return c.name; }).slice(1)
                });
            }
        });
    };
