...
export type PLAYER_ACTIONS = 'PLAYER_FOUND' | 'PLAYER_SEEK_FORWARD' | 'PLAYER_SEEK_BACKWARD' | 'PLAYER_PLAY' | 'PLAYER_PAUSE' | 'CHANGE_VOLUME' | 'PLAYER_ENTER_FULLSCREEN' | 'PLAYER_EXIT_FULLSCREEN'
