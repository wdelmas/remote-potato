...
export type PLAYER_ACTIONS = 'PLAYER_FOUND' | 'PLAYER_SEEK_FORWARD' | 'PLAYER_SEEK_BACKWARD' | 'PLAYER_PLAY' | 'PLAYER_PAUSE' | 'PLAYER_VOLUME_UP' | 'PLAYER_VOLUME_DOWN' | 'PLAYER_ENTER_FULLSCREEN' | 'PLAYER_EXIT_FULLSCREEN'
